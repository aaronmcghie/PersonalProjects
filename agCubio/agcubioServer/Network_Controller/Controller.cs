...
namespace Network_Controller
{
    ...
    public static class Controller
    {
        ...
        public static void Server_Awaiting_Client_Loop(Action<StateObject> cbFunction)
        {
            String output = "";
        ...
        {
            Socket socket = ((StateObject)ar).socket;
            ((StateObject)ar).cbFunction.Invoke((StateObject)ar);
        }
    }
}
